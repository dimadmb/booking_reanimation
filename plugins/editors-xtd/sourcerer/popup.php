...
class PlgButtonSourcererPopup
{
	...
	function render()
	{
		...
		RLFunctions::script('regularlabs/script.min.js', '16.4.22039');
		RLFunctions::stylesheet('regularlabs/popup.min.css', '16.4.22039');
		RLFunctions::stylesheet('regularlabs/style.min.css', '16.4.22039');
		...
		RLFunctions::script('sourcerer/script.min.js', '6.0.1');
		RLFunctions::stylesheet('sourcerer/popup.min.css', '6.0.1');
