...
if (!function_exists('utf8_is_ascii_ctrl')) {
...
*/
if (!function_exists('utf8_strip_non_ascii')) {
...
*/
if (!function_exists('utf8_strip_ascii_ctrl')) {
...
* @subpackage ascii
*/
if (!function_exists('utf8_strip_non_ascii_ctrl')) {
...
* @subpackage ascii
*/
if (!function_exists('utf8_accents_to_ascii')) {
